...
public class LayoutPlanController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet LayoutPlanController at " + request.getContextPath() + "</h1>");
            ...
            RequestDispatcher rd=request.getRequestDispatcher("admin/CreateLayoutPlanResult.jsp");
